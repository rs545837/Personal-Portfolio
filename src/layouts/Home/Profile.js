...
const ProfileText = ({ visible, titleId }) => (
  <Fragment>
    ...
    <Text className={styles.description} data-visible={visible} size="l" as="p">
      I’m Rohan, currently I amstudying at <Link href="https://www.ucla.edu">UCLA</Link>.
    ...
    <Text className={styles.description} data-visible={visible} size="l" as="p">
      In my spare time I like to practice fingerstyle guitar and play Badminton&#127992;.
      I know a bit of japanese too, therefore you will see some japanese here. I’m always
